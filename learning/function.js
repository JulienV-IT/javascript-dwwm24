...
// si function / var / class / let / array alors javascript
...
const tabwords= ["nous", "aimons", "aller", "de", "l'avant", "!"];
...
titre.innerHTML = "mon nouveau titre ca grand mere";
corp.appendChild(titre);	
